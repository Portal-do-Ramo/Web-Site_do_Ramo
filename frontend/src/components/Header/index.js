...
export default function Header({ page, children }) {
  ...
  return (
    <>
      <header
        className={
          page === 'inicio' ? styles.homeHeader : styles.headerContainer
        }
      >
        <div className={styles.logoContainer}>
          ...
          <section>
            ...
            <p>
              Desenvolvendo pessoas através de projetos técnicos e/ou sociais
            </p>
          </section>
        </div>
        ...
        <div className={styles.navIcon} onClick={open}>
          <svg
            className={isOpen ? styles.hamActivated : styles.ham}
            viewBox='0 0 100 100'
            height={50}
          >
            <path
            ...
            />
            <path className={styles.line} id='middle' d='m 30,50 h 40' />
            <path
              className={styles.line}
        ...
        <div
          className={
            isOpen ? styles.linkContainerActivated : styles.linkContainer
          }
        >
          <Link href='/'>
          ...
          <Link href='/equipes'>
            <a className={page === 'equipes' ? styles.activeLink : null}>
              Equipes
            </a>
          </Link>

          <Link href='/PSE'>
            <a className={page === 'PSE' ? styles.activeLink : null}>
              Processo Seletivo
            </a>
          </Link>

          <Link href='/login'>Administrador</Link>
        </div>
