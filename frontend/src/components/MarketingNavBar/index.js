    ...
    <div className={styles.all}>
      ...
      <div className={isOpen ? styles.routesActivated : styles.routes}>
        ...
        <Link href={`/marketing/equipes`}>
          <h1 className={page === 'equipes' ? styles.border : null}>
            {user && user.isAdmin ? 'Equipes' : 'Equipe'}
          </h1>
        </Link>
        ...
        {user && user.isAdmin && (
          <>
            ...
            <Link href={`/marketing/admin`}>
              <h1 className={page === 'admin' ? styles.border : null}>
                Administradores
              </h1>
            </Link>
          </>
      ...
      <div className={styles.user}>
        {user && user.isAdmin ? (
          ...
          <img
            src={crews.find((crew) => crew.id === user.crewId)?.imageURL}
