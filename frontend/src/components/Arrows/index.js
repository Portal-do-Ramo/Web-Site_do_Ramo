...
export const AwardNextArrow = ({ onClick, disabled }) => {
  return (
    <div className={disabled ? styles.awardNextDisabled : styles.awardNext} onClick={onClick}>
...
export const AwardPrevArrow = ({ onClick, disabled }) => {
  return (
    <div className={disabled ? styles.awardPrevDisabled : styles.awardPrev} onClick={onClick}>
