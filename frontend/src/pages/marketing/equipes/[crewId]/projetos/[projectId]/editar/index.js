  ...
  useEffect(() => {
    ...
    async function execute() {
      ...
      if (project.ended) {
        ...
        endDateFormatted.setMinutes(
          endDateFormatted.getMinutes() - endDateFormatted.getTimezoneOffset()
        );
          ...
          <div className={styles.content}>
            ...
            <div className={styles.buttonRow}>
              <button
                ...
                onClick={() =>
                  router.push(
                    `/marketing/equipes/${crew.id}/projetos/${project.id}`
                  )
                }
              >
                {' '}
              ...
              <button className={styles.edit} onClick={handleUpdateProject}>
                {' '}
                Editar{' '}
              </button>
            </div>
